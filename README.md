...
<title>LuaHub</title>
<meta name="description" content="LuaHub - Share your Roblox Lua scripts">
...
:root{
  --bg:#010108;--bg2:#04040e;--bg3:#070714;--bg4:#0a0a1c;--bg5:#0e0e26;
  --border:#161640;--border2:#1e1e55;
  --accent:#6366f1;--accent2:#8b5cf6;
  --green:#27ae60;--red:#e74c3c;--gold:#f1c40f;
  --text:#eaeaff;--text2:#7878aa;--text3:#404068;
  --server:#f0f0ff;--local:#60a5fa;--module:#c4b5fd;
  --r:14px;--rsm:9px;
...
body::before{content:'';position:fixed;inset:0;background-image:linear-gradient(rgba(99,102,241,0.03) 1px,transparent 1px),linear-gradient(90deg,rgba(99,102,241,0.03) 1px,transparent 1px);background-size:44px 44px;pointer-events:none;z-index:0}
body::after{content:'';position:fixed;top:-40%;left:-40%;width:180%;height:180%;background:radial-gradient(ellipse at 20% 15%,rgba(99,102,241,0.1) 0%,transparent 50%),radial-gradient(ellipse at 80% 85%,rgba(139,92,246,0.08) 0%,transparent 50%),radial-gradient(ellipse at 50% 50%,rgba(59,130,246,0.03) 0%,transparent 70%);pointer-events:none;z-index:0;animation:bgp 9s ease-in-out infinite alternate}
...
/* HEADER */
.header{display:flex;justify-content:space-between;align-items:center;position:sticky;top:8px;z-index:100;padding:14px 20px;background:rgba(5,5,18,0.95);border:1px solid rgba(99,102,241,0.25);border-radius:20px;margin-bottom:12px;position:relative;box-shadow:0 4px 30px rgba(0,0,0,0.7),0 0 60px rgba(99,102,241,0.04),inset 0 1px 0 rgba(255,255,255,0.05);backdrop-filter:blur(20px)}
...
.logo-hub{color:var(--accent);text-shadow:0 0 22px rgba(91,142,240,0.7),0 0 60px rgba(91,142,240,0.3)}
...
.ibtn.add-btn{background:linear-gradient(135deg,#22c55e,#16a34a);color:white;box-shadow:0 2px 14px rgba(34,197,94,0.4);font-size:20px;font-family:'Fredoka One',cursive}
...
/* PROFILE PANEL */
.pp{display:none;position:fixed;top:70px;right:calc(50% - 290px + 8px);width:248px;background:rgba(5,5,18,0.97);border:1px solid rgba(99,102,241,0.22);border-radius:18px;padding:18px 16px;z-index:2000;box-shadow:0 20px 60px rgba(0,0,0,0.9),0 0 40px rgba(99,102,241,0.06);text-align:center;backdrop-filter:blur(28px)}
...
/* SEARCH */
.sw{display:flex;gap:8px;align-items:stretch;background:rgba(5,5,15,0.8);border:1px solid rgba(99,102,241,0.18);border-radius:16px;padding:9px;margin-bottom:12px;backdrop-filter:blur(10px)}
...
.si:focus{border-color:var(--accent);box-shadow:0 0 0 3px rgba(99,102,241,0.1),0 0 12px rgba(99,102,241,0.15)}
...
.drop-menu{display:none;position:absolute;top:calc(100% + 6px);right:0;background:rgba(6,6,22,0.98);border:1px solid rgba(99,102,241,0.25);border-radius:14px;padding:6px;z-index:9999;min-width:190px;box-shadow:0 20px 60px rgba(0,0,0,0.9),inset 0 1px 0 rgba(255,255,255,0.04);backdrop-filter:blur(30px)}
.drop-menu.open{display:block;animation:slideDown 0.18s cubic-bezier(0.34,1.56,0.64,1) both}
...
/* CODE */
pre[class*="language-"]{border-radius:12px;overflow-x:auto;max-height:360px;margin-top:10px;background:#010109 !important;border:1px solid rgba(30,30,80,0.8);font-size:12px;box-shadow:inset 0 2px 10px rgba(0,0,0,0.5),0 0 20px rgba(99,102,241,0.04)}
code[class*="language-"]{font-family:'Fira Code',monospace;font-size:12px;text-shadow:0 0 8px rgba(180,180,255,0.15)}
...
.rbtn{display:inline-flex;align-items:center;gap:5px;background:rgba(14,14,38,0.8);border:1px solid rgba(30,30,70,0.9);border-radius:20px;color:#404068;padding:6px 14px;font-size:12px;font-family:'Inter',sans-serif;font-weight:600;cursor:pointer;transition:all var(--tr)}
.rbtn:hover{background:var(--bg4);color:var(--text2)}
.rbtn.lkd{background:rgba(34,197,94,0.12);border-color:rgba(34,197,94,0.35);color:#4ade80;box-shadow:0 0 16px rgba(34,197,94,0.15)}
.rbtn.dlkd{background:rgba(239,68,68,0.12);border-color:rgba(239,68,68,0.35);color:#f87171;box-shadow:0 0 16px rgba(239,68,68,0.15)}
...
.modal-box{background:rgba(5,5,18,0.98);border:1px solid rgba(99,102,241,0.22);border-radius:24px;padding:28px;width:100%;max-width:420px;box-shadow:0 32px 90px rgba(0,0,0,0.97),0 0 80px rgba(99,102,241,0.06),inset 0 1px 0 rgba(255,255,255,0.04);position:relative;text-align:center;backdrop-filter:blur(32px)}
...
.btn.pr{background:linear-gradient(135deg,#6366f1,#4f46e5);color:white;box-shadow:0 4px 18px rgba(99,102,241,0.35);letter-spacing:0.2px}
...
.btn.full{width:100%}
.btn-login{background:linear-gradient(135deg,#6366f1,#4f46e5);color:white;border:none;border-radius:var(--rsm);padding:9px 22px;font-family:'Fredoka One',cursive;font-size:14px;cursor:pointer;transition:all var(--tr);box-shadow:0 4px 18px rgba(99,102,241,0.35);letter-spacing:0.2px}
...
/* FOLDER CARD */
.fcard{background:linear-gradient(145deg,rgba(8,8,28,0.95),rgba(5,5,18,0.98));border:1px solid rgba(40,40,100,0.7);border-radius:20px;padding:18px 18px 14px;margin-bottom:14px;position:relative;box-shadow:0 4px 28px rgba(0,0,0,0.7),inset 0 1px 0 rgba(255,255,255,0.03);transition:border-color 0.3s ease,box-shadow 0.3s ease,transform 0.3s ease;overflow:visible}
.fcard:hover{border-color:rgba(99,102,241,0.45);box-shadow:0 12px 40px rgba(0,0,0,0.75),0 0 60px rgba(99,102,241,0.06);transform:translateY(-1px)}
.fhd{display:flex;align-items:center;gap:8px;margin-bottom:6px}
.fchev{background:none;border:none;cursor:pointer;color:#3a3a90;font-size:12px;padding:5px;border-radius:8px;transition:all var(--tr);display:flex;align-items:center;justify-content:center;flex-shrink:0}
.fchev:hover{background:rgba(99,102,241,0.1);color:#8888ee}
.fchev.open{transform:rotate(90deg);color:var(--accent)}
.ftitle{font-family:'Fredoka One',cursive;font-size:19px;color:#dde0ff;flex:1;line-height:1.2;text-shadow:0 0 24px rgba(140,130,255,0.5),0 0 48px rgba(99,102,241,0.25),0 0 80px rgba(99,102,241,0.1)}
.fdesc{color:#5a5a88;font-family:'Inter',sans-serif;font-size:13px;margin-bottom:8px;line-height:1.6}
.fmeta-nm{cursor:pointer;color:var(--accent);font-weight:600;font-size:11px;transition:text-shadow var(--tr)}.fmeta-nm:hover{text-shadow:0 0 14px rgba(99,102,241,0.8)}
.fmeta{display:flex;align-items:center;gap:7px;flex-wrap:wrap;font-family:'Inter',sans-serif;font-size:11px;color:#505080;margin-bottom:7px}
...
.sadd-btn{flex:0 0 auto;display:flex;align-items:center;justify-content:center;gap:6px;background:rgba(8,8,28,0.8);color:#4040a0;border:1px solid rgba(40,40,100,0.6);border-radius:20px;padding:7px 14px;font-family:'Inter',sans-serif;font-size:12px;font-weight:600;cursor:pointer;transition:all var(--tr);white-space:nowrap}
.sadd-btn:hover{background:rgba(99,102,241,0.1);color:#a5b4fc;border-color:rgba(99,102,241,0.4);box-shadow:0 0 16px rgba(99,102,241,0.12)}

/* SCRIPT CARD (inside folder) */
.scard{background:linear-gradient(145deg,rgba(4,4,18,0.9),rgba(3,3,14,0.95));border:1px solid rgba(25,25,75,0.7);border-radius:14px;padding:14px;margin-bottom:10px;position:relative;transition:border-color 0.3s ease,box-shadow 0.3s ease;box-shadow:0 2px 12px rgba(0,0,0,0.4)}
.scard:hover{border-color:rgba(99,102,241,0.35);box-shadow:0 6px 24px rgba(0,0,0,0.5),0 0 30px rgba(99,102,241,0.07)}
.sbadge{display:inline-flex;align-items:center;gap:5px;font-size:10px;font-family:'Fira Code',monospace;font-weight:700;padding:4px 11px;border-radius:20px;margin-bottom:8px;letter-spacing:0.3px}
.sbadge.srv{background:rgba(255,255,255,0.07);color:#f0f0ff;border:1px solid rgba(255,255,255,0.22);text-shadow:0 0 12px rgba(255,255,255,0.6),0 0 24px rgba(200,200,255,0.3);box-shadow:0 0 12px rgba(255,255,255,0.08)}
.sbadge.lcl{background:rgba(59,130,246,0.12);color:#60a5fa;border:1px solid rgba(59,130,246,0.35);text-shadow:0 0 12px rgba(96,165,250,0.7),0 0 28px rgba(59,130,246,0.4);box-shadow:0 0 14px rgba(59,130,246,0.12)}
.sbadge.mod{background:rgba(139,92,246,0.12);color:#c4b5fd;border:1px solid rgba(139,92,246,0.4);text-shadow:0 0 12px rgba(196,181,253,0.7),0 0 28px rgba(139,92,246,0.5);box-shadow:0 0 14px rgba(139,92,246,0.15)}
.stitle{font-family:'Fredoka One',cursive;font-size:15px;color:#dde0ff;margin-bottom:4px;text-shadow:0 0 18px rgba(140,130,255,0.45),0 0 36px rgba(99,102,241,0.2)}
.sdesc{font-family:'Inter',sans-serif;font-size:12px;color:#4a4a78;margin-bottom:7px;line-height:1.5}
...
::-webkit-scrollbar-thumb:hover{background:var(--accent);box-shadow:0 0 6px rgba(99,102,241,0.5)}
...
.instr-toggle{display:flex;align-items:center;gap:8px;cursor:pointer;padding:9px 13px;background:rgba(99,102,241,0.06);border:1px solid rgba(99,102,241,0.16);border-radius:11px;transition:all var(--tr);user-select:none}
...
.instr-content{padding:14px 16px;background:rgba(2,2,8,0.85);border:1px solid rgba(99,102,241,0.15);border-top:none;border-radius:0 0 11px 11px;font-family:'Inter',sans-serif;font-size:13px;color:#6868a0;line-height:1.85;white-space:pre-wrap;word-break:break-word;text-shadow:0 0 24px rgba(99,102,241,0.15)}
...
.cat-btn{flex:0 0 auto;display:flex;align-items:center;gap:6px;padding:8px 18px;background:var(--bg4);border:1px solid var(--border2);border-radius:20px;color:var(--text2);font-family:'Inter',sans-serif;font-size:12px;font-weight:500;cursor:pointer;transition:all var(--tr);white-space:nowrap;letter-spacing:0.1px}
...
.fcard.owner-folder{border-color:rgba(241,196,15,0.28);box-shadow:0 4px 28px rgba(0,0,0,0.7),0 0 40px rgba(241,196,15,0.05)}
.fcard.owner-folder:hover{border-color:rgba(241,196,15,0.5);box-shadow:0 12px 40px rgba(0,0,0,0.75),0 0 60px rgba(241,196,15,0.08)}

/* FAVOURITE */
.fav-btn{position:absolute;top:17px;left:15px;font-size:14px;cursor:pointer;color:#2a2a5a;transition:all var(--tr);background:none;border:none;line-height:1;padding:3px;border-radius:6px}
.fav-btn:hover{color:var(--gold);transform:scale(1.15)}
.fav-btn.on{color:#fbbf24;text-shadow:0 0 14px rgba(251,191,36,0.8),0 0 28px rgba(251,191,36,0.4)}

/* DASHBOARD */
.ibtn.dash-btn{background:linear-gradient(135deg,#4f46e5,#7c3aed);color:white;box-shadow:0 2px 14px rgba(79,70,229,0.45)}
...
/* ── GLOW & POLISH ───────────────────────────────── */
/* Folder title stronger glow */
.ftitle{text-shadow:0 0 16px rgba(160,170,255,0.5),0 0 40px rgba(99,102,241,0.2)!important}
/* Script title glow */
.stitle{text-shadow:0 0 12px rgba(150,160,255,0.45),0 0 28px rgba(99,102,241,0.18)!important}
/* Code block glow border */
pre[class*="language-"]{box-shadow:0 0 20px rgba(0,0,0,0.6),0 0 1px rgba(99,102,241,0.12)!important}
/* Modal title glow */
.mt{text-shadow:0 0 20px rgba(140,150,255,0.35)}
/* Logo hub gradient (already set but override) */
.logo-hub{filter:drop-shadow(0 0 8px rgba(99,102,241,0.6))}
/* Accent link / user name global glow on hover */
.fmeta-nm:hover{text-shadow:0 0 12px rgba(99,102,241,0.75),0 0 24px rgba(99,102,241,0.35)}
/* Owner badge gold glow */
.up-owner-badge{box-shadow:0 0 12px rgba(245,158,11,0.2)}
/* Reaction liked glow */
.rbtn.lkd{box-shadow:0 0 12px rgba(34,197,94,0.2)}
.rbtn.dlkd{box-shadow:0 0 12px rgba(239,68,68,0.15)}
/* Cat btn active - subtle glow */
.cat-btn.act{box-shadow:0 0 14px rgba(99,102,241,0.15)}
.cat-btn.cat-owner.act{box-shadow:0 0 14px rgba(245,158,11,0.12)}
/* Instr toggle glow on hover */
.instr-toggle:hover{box-shadow:0 0 16px rgba(99,102,241,0.1)}
/* pfp header glow */
.pfp-hdr:hover{box-shadow:0 0 18px rgba(99,102,241,0.55)!important}
/* Button hover glow */
.btn.pr:hover{box-shadow:0 6px 24px rgba(99,102,241,0.5)!important}
.btn.suc:hover{box-shadow:0 6px 24px rgba(34,197,94,0.45)!important}
.btn.dng:hover{box-shadow:0 6px 24px rgba(239,68,68,0.45)!important}
/* Dashboard item glow */
.dfi-nm{font-family:'Fredoka One',cursive;font-size:14px;color:var(--text);text-shadow:0 0 10px rgba(140,150,255,0.3)}
/* Script add buttons */
.sadd-btn.srv:hover{color:#f0f0ff;border-color:rgba(240,240,255,0.5);box-shadow:0 0 12px rgba(255,255,255,0.1);background:rgba(240,240,255,0.06)}
.sadd-btn.lcl:hover{color:#60a5fa;border-color:rgba(96,165,250,0.5);box-shadow:0 0 12px rgba(96,165,250,0.15);background:rgba(96,165,250,0.06)}
.sadd-btn.mod:hover{color:#a78bfa;border-color:rgba(167,139,250,0.5);box-shadow:0 0 12px rgba(167,139,250,0.15);background:rgba(167,139,250,0.06)}
/* pp bio glow on hover */
.pp-bio-box:hover{border-color:var(--accent);box-shadow:0 0 12px rgba(99,102,241,0.12)}
...
<div class="modal" id="userModal">
  <div class="modal-box wide" style="text-align:center">
    ...
    <div class="up-bel" id="um-bel" style="display:none">
      <div class="up-bel-lbl">&#x1F3C6; Beloved Folder</div>
...
<div class="modal" id="dashModal">
  <div class="modal-box wide" style="text-align:left;max-width:500px">
    ...
    <div class="dash-tabs">
      ...
      <button class="dash-tab" id="dtab-liked" onclick="dTab('liked')">&#x1F44D; Liked</button>
      <button class="dash-tab" id="dtab-my" onclick="dTab('my')">&#x1F4C2; My Folders</button>
    </div>
...
function updPP(){
  ...
  document.getElementById('pp').innerHTML=`
    ...
    <div class="pp-bl-lbl">&#x1F3C6; Beloved Folder</div>
    <div class="pp-bl">${bel?esc(bel.name):'No folders yet!'}</div>
    <button class="pp-out" onclick="logout()"><i class="fas fa-sign-out-alt" style="font-size:11px"></i> Logout</button>
  `;
}
function getBeloved(u){
  let best=null,bs=-1;
  D.folders.filter(f=>f.author===u).forEach(f=>{
    const sc=Object.values(f.userReactions||{}).filter(r=>r==='like').length;
  ...
  el.innerHTML=`
    ...
    <div class="fhd" style="${curUser?'padding-left:24px':''}">
      ...
      <div style="position:relative;margin-left:auto">
        ...
        <div class="drop-menu" id="fdm-${f.id}">
    ...
    <div class="fmeta" style="${curUser?'padding-left:24px':''}">
      ...
      <span class="fmeta-nm" onclick="openUserProfile('${esc(f.author)}')">${esc(f.author)}${f.author==='Tasin Redwan'?' &#x1F451;':''}</span>
...
function dTab(t){
  ...
  document.getElementById('dtab-my').classList.toggle('act',t==='my');
  showDash();
}
function showDash(){
  ...
  if(_dTab==='fav'){
    ...
    folders=D.folders.filter(f=>f.author===curUser.username);
  } else {
...
function buildSC(fs,fid,mine,admin){
  ...
  const label=fs.scriptType==='ServerScript'?'<i class="fas fa-server" style="font-size:9px"></i> ServerScript':fs.scriptType==='LocalScript'?'<i class="fas fa-laptop" style="font-size:9px"></i> LocalScript':'<i class="fas fa-cube" style="font-size:9px"></i> ModuleScript';
  const notMine=!mine;
  return `<div class="scard" id="sc-${fs.id}">
    ...
    <div style="position:relative;float:right;display:inline-block">
      ...
      <div class="drop-menu" id="sdm-${fs.id}">
...
function openUserProfile(username){
  ...
  if(bel){bEl.style.display='block';document.getElementById('um-bel-nm').textContent=bel.name;}else bEl.style.display='none';
...
// === INIT ===
window.addEventListener('scroll',()=>{document.querySelectorAll('.drop-menu.open').forEach(m=>m.classList.remove('open'));},true);
window.onload=()=>{chkShare();renderHdr();renderAll();};
</script>
</body>
</html>.pp-bl-lbl{font-size:10px;color:var(--text3);letter-spacing:1px;text-transform:uppercase;margin-top:10px;font-family:'Inter',sans-serif}
.pp-bl{background:var(--bg2);padding:8px 10px;border-radius:8px;margin-top:5px;font-size:12px;border:1px solid var(--border);color:var(--text2);font-family:'Inter',sans-serif;text-align:left}
.pp-out{width:100%;margin-top:14px;background:linear-gradient(135deg,var(--red),#c0392b);color:white;border:none;border-radius:var(--rsm);padding:9px;font-family:'Fredoka One',cursive;font-size:14px;cursor:pointer;transition:all var(--tr)}
.pp-out:hover{opacity:0.88;transform:translateY(-1px)}
